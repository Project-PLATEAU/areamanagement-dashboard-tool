...
var customConfig = require('terriajs/customconfig.json');
...
module.exports = function(devMode, hot) {
    var config = {
        ...
        output: {
            ...
            publicPath: hot ? 'http://localhost:3003/build/' : customConfig.config.plateauPath + '/build/',
                    ...
                    use: [
                        {
                            ...
                            options: {
                                ...
                                search: 'function _get\\(\\).*?return _get\\.apply\\(this, arguments\\).*',
