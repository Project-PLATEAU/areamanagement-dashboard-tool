      ...
      .map((catalogItem, i) => {
        ...
        return (
          <FeatureInfoCatalogItem
            ...
            highlightGraphAndFilterList={this.props.highlightGraphAndFilterList}
          />
        );
      });
  }
        ...
        >
          {!this.props.printView && (
            <div className={Styles.header}>
              ...
              >
                ...
                >
                  {this.props.viewState.featureInfoPanelIsCollapsed ? (
                    <Icon glyph={Icon.GLYPHS.closed} style={{fill:"#536285"}}/>
                  ) : (
                    <Icon glyph={Icon.GLYPHS.opened} style={{fill:"#536285"}}/>
                  )}
                </button>
              </div>
              <button
              ...
              >
                <Icon glyph={Icon.GLYPHS.close}  style={{fill:"#000000"}}/>
              </button>
            </div>
          )}
          <ul className={Styles.body} css={`
