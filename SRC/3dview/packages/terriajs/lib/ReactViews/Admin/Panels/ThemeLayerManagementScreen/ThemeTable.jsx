...
export default function Content(props) {
    ...
    return (
        <>
            <table className={Style1.themeLayerTable} style={{width:"100%", borderSpacing: "0px"}}>
                <thead className>
                        ...
                        `}>
                            {columns.map((value2) =>
                                ...
                                `}>
                                    ...
                                    {value2.field == "themeGroupName" && (
                                        <Input
                                            light={true}
                                            dark={false}
                                            type="text"
                                            className={"themeGroupName"}
                                            defaultValue={value1[value2.field] || value1["layerForm"]?.[value2.field]}
                                        />
                                    )}
                                    {value2.field == "dispOrder" && (
                                        <Input
                                            light={true}
                                            dark={false}
                                            type="number"
                                            min="0"
                                            id={"dispOrderForTheme" + index}
                                            className={"dispNumForTheme"}
                                            defaultValue={value1[value2.field] || value1["layerForm"]?.[value2.field]}
                                        />
                                    )}
                                </td>
