...
export const GLYPHS = {
  ...
  network: require("../../wwwroot/images/icons/network.svg"),
  people: require("../../wwwroot/images/icons/people.svg"),
  peopleColorChange: require("../../wwwroot/images/icons/people-color-change.svg"),
  dashboard: require("../../wwwroot/images/icons/dashboard.svg"),
  logout: require("../../wwwroot/images/icons/logout-circle-svgrepo-com.svg"),
  mapmenu: require("../../wwwroot/images/icons/menu-svgrepo-com.svg"),
  networkperson: require("../../wwwroot/images/icons/network-1-svgrepo-com.svg"),
  networkroute: require("../../wwwroot/images/icons/network-svgrepo-com.svg"),
  routesearch: require("../../wwwroot/images/icons/search-svgrepo-com.svg"),
  information: require("../../wwwroot/images/icons/information.svg")
};
