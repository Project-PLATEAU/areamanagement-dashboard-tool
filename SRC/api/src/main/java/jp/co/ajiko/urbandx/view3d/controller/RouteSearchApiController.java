...
import jp.co.ajiko.urbandx.view3d.service.RouteSearchService;
...
public class RouteSearchApiController {
	...
	@ApiOperation(value = "条件付き経路探索を実施", notes = "条件付き経路探索を実施")
	@ResponseBody
	@ApiResponses(value = {
	...
	public RouteSearchResultForm routeSearch(@ApiParam(required = true, value = "開始地点緯度経度")@RequestParam("start") String start, @ApiParam(required = true, value = "終了地点緯度経度")@RequestParam("end") String end, @ApiParam(required = true, value = "検索条件")@RequestParam("condition") Integer condition) {
